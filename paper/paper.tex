...
\title{Eastwood: C Linting for Automated Code Style Enforcement in Programming Courses}
...
\begin{abstract}
  ...
  automated linting tool \textit{Eastwood} that provides on-demand style violation and fix
